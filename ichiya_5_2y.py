...
GAME_TITLE = "Ichiya space Rescue"
...
class OneKeyGame:
    ...
    def reset_game(self):
        ...
        self.score = 1000000000000000000000000000000
    ...
    # 隕石を追加する
    def add_meteor(self):
        meteor_pos = self.generate_distanced_pos(60)# 宇宙船から距離を６０以上離す
